...
export enable_anari=true
export enable_mpi=ON
export enable_find_mpi=OFF
export enable_mpicc=ON
export enable_openmp=ON
export enable_python=OFF
export enable_find_python=OFF
# export Python_ROOT_DIR=/home/droaperdomo/python_venv/venv
export build_jobs=8
