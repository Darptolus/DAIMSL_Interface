...
env prefix=/home/droaperdomo/ascent_anari/obj_bin build_anari=true enable_mpi=ON enable_openmp=ON enable_mpicc=ON enable_find_mpi=OFF enable_openmp=ON enable_python=OFF ./build_ascent.sh
