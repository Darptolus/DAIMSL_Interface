...
#####
# env prefix=/home/droaperdomo/ascent_anari/obj_bin_p build_anari=true ./build_ascent.sh

# Works
env build_anari=true enable_mpi=ON enable_openmp=ON enable_mpicc=ON enable_find_mpi=OFF enable_openmp=ON enable_python=OFF ./build_ascent.sh

# Fails
# env prefix=/home/droaperdomo/ascent_anari/obj_bin_p enable_python=ON build_anari=true enable_mpi=ON enable_openmp=ON enable_mpicc=ON enable_find_mpi=OFF enable_openmp=ON ./build_ascent.sh
# env prefix=/home/droaperdomo/ascent_anari/obj_bin_p build_anari=true enable_python=ON enable_mpi=ON enable_openmp=ON enable_mpicc=ON enable_find_mpi=OFF enable_openmp=ON ./build_ascent.sh
# env prefix=/home/droaperdomo/ascent_anari/obj_bin_p build_anari=true enable_mpi=ON enable_python=ON enable_openmp=ON enable_mpicc=ON enable_find_mpi=OFF enable_openmp=ON ./build_ascent.sh
# env prefix=/home/droaperdomo/ascent_anari/obj_bin_p build_anari=true enable_mpi=ON enable_openmp=ON enable_python=ON enable_mpicc=ON enable_find_mpi=OFF enable_openmp=ON ./build_ascent.sh

#####
# env prefix=/home/droaperdomo/ascent_anari/obj_bin enable_find_mpi=OFF enable_mpi=ON enable_mpicc=ON enable_openmp=ON enable_anari=true build_jobs=8 ./build_ascent.sh
